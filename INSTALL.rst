...
2. Get the code:
   ...
   .. code-block:: bash
       ...
       $ git clone git@github.com:VNG-Realisatie/gemma-{{ project_name|lower }}
...
1. Clone or download the code from `Github`_ in a folder like
   ...
   .. code-block:: bash
       ...
       $ git clone git@bitbucket.org:VNG-Realisatie/gemma-{{ project_name|lower }} {{ project_name|lower }}
